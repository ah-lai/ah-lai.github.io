            ...
            <section>
                <div id="about" class={styles.condiv}>
                    ...
                    <p className={styles.about}>
                        ...
                        <br></br>
                        <br></br>
                        I have strong problem solving skills and am diligent in self-learning, leading me to achieve a spot on the Dean's List in multiple semesters and an overall GPA of 3.9/4. 
